...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_LEFT,        KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    MT(MOD_RSFT, KC_QUOT),
                KC_LCTL,    KC_LGUI,    KC_LALT,    LOWER,      KC_SPC,                     KC_SPC,     RAISE,      KC_RALT,    KC_DOWN,    KC_UP
    ),
    ...
    _______,    RGB_TOG,    RGB_MOD,    RGB_RMOD,   RGB_SAD,    RGB_SAI,                    _______,    _______,    _______,    _______,    _______,    _______,
    KC_CAPSLOCK,_______,    RGB_HUD,    RGB_HUI,    RGB_VAD,    RGB_VAI,    KC_VOLU,        _______,    _______,    _______,    _______,    _______,    _______,
